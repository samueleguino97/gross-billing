...
export interface FacturacionCompraVentaClient extends SoapClient {
    ...
    recepcionAnexosAsync(recepcionAnexos: TnsrecepcionAnexos, options?: ISoapExOptions): Promise<[result: TnsrecepcionAnexosResponse, rawResponse: any, soapHeader: any, rawRequest: any]>;
...
/** Create FacturacionCompraVentaClient */
export function createClientAsync(...args: Parameters<typeof soapCreateClientAsync>): Promise<FacturacionCompraVentaClient> {
