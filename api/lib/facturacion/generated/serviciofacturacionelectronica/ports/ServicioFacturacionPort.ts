...
export interface ServicioFacturacionPort {
    ...
    recepcionAnexosSuministroEnergia(recepcionAnexosSuministroEnergia: TnsrecepcionAnexosSuministroEnergia, callback: (err: any, result: TnsrecepcionAnexosSuministroEnergiaResponse, rawResponse: any, soapHeader: any, rawRequest: any) => void): void;
}
